    ...
    <div class="flex items-center gap-2">
      ...
      <div class="flex gap-2 items-center justify-between flex-1">
        <input
          ...
          :style="{
            background: `linear-gradient(to right, var(--ink-gray-8, #171717) ${progress}%, var(--surface-gray-3, #ededed) ${progress}%)`,
          }"
          type="range"
          min="0"
          :max="duration"
      ...
      <div class="flex items-center gap-1">
        <div class="flex group gap-2 items-center">
          <input
            ...
            :style="{
              background: `linear-gradient(to right, var(--ink-gray-8, #171717) ${volumnProgress}%, var(--surface-gray-3, #ededed) ${volumnProgress}%)`,
            }"
            type="range"
            min="0"
            max="1"
